...
import { download } from "@/lib/studio-utils";
    ...
    <div className="mx-auto max-md:space-y-6 md:flex max-w-[1400px] items-center gap-2 pb-3 max-md:space-x-2">
      ...
      <div className="ml-auto flex items-center gap-2">
        <Button
          variant="secondary"
          className={
            "h-9 rounded-full cursor-pointer disabled:cursor-not-allowed bg-linear-to-bl from-pink-400 to-pink-800 px-5 text-white"
          }
          onClick={onSave}
