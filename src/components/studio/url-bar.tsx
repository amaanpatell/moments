...
export default function UrlBar({ url }: { url: string }) {
  const copyUrl = async () => {
    try {
  ...
  return (
    <div className="flex items-center gap-2.5 my-2">
      <Input
        readOnly
        value={url}
        className="font-mono text-xs shadow-none dark:bg-transparent backdrop-blur-sm focus-visible:outline-none focus-visible:ring-0 border-pink-300/30  dark:border-pink-200/15 h-9"
