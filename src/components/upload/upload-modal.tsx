      ...
      <DialogContent className="flex max-h-[90vh] max-w-4xl flex-col overflow-hidden border-zinc-500/30 backdrop-blur-lg sm:p-10 dark:bg-black/70 [&>button:last-child]:hidden">
        ...
        <div className="flex-1 space-y-4 overflow-y-auto">
          <div
            {...getRootProps()}
            className={cn(
              "cursor-pointer rounded-lg border border-dashed border-rose-300 p-8 text-center transition-colors dark:border-pink-200/30",
          ...
          <div className="flex space-x-3">
            ...
            {pendingCount > 0 && (
              <Button
                ...
                disabled={isUploading}
                className="bg-linear-to-bl from-pink-400 to-pink-800"
              >
                {isUploading
                  ? "Uploading..."
